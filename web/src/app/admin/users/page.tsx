...
import UserTable from "@/components/shared/(admin)/users/UserTable"
        ...
        <AdminAppLayout>
            <div className="max-w-7xl mx-auto pb-20">
                <div className="flex justify-between items-center mb-8">
                    <h1 className="text-3xl font-black italic tracking-tighter uppercase text-[var(--foreground)]">User</h1>
                    <Link
